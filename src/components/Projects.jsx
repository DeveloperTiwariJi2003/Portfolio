...
const projects = [
  ...
  {title: "Portfolio",
    ...
    description: "Developed a secure cloud storage application with user authentication using JWT and bcrypt, Implemented single and multiple file uploads, downloads, previews, and bulk deletion with user-specific access control, Stored uploaded files on a self-hosted local storage system while maintaining file metadata in MongoDB Atlas,Built a RESTful backend using Express.js with a modular architecture (Routes, Controllers, Middlewares), Integrated Cloudflare Tunnel with a custom domain to securely expose the local server over the internet without traditional port forwarding.",
    image: drive,
